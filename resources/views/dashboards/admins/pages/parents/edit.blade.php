        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Parent Data</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="card card-info">
        <div class="card-header d-flex justify-content-between w-100">
          <h3 class="card-title"><i class="fa-solid fa-edit mr-2"></i>Edit Parent</h3>
        </div>
        <!-- /.card-header -->
                  ...
                  <div class="form-group ">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control"
                              data-inputmask="'mask': ['99999999999999', '+099 99 99 9999[9]-9999']" data-mask>
                      </div>
                      <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
