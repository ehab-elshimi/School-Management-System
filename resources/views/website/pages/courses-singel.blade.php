            ...
            <div class="col-lg-8">
                <div class="corses-singel-left mt-30">
                        ...
                        <ul>
                            <li>
                                <div class="teacher-name">
                                    <div class="thum">
                                        <img src="{{ asset('website/images/course/teacher/t-1.jpg') }}" alt="Teacher">
                                    </div>
                                    <div class="name">
                                        <span>Teacher</span>
                                        <h6>Mark anthem</h6>
                    ...
                    <div class="corses-singel-image pt-50">
                        <img src="{{ asset('website/images/course/cu-1.jpg') }}" alt="Courses">
                                ...
                                <div class="instructor-cont">
                                    <div class="instructor-author">
                                        <div class="author-thum">
                                            <img src="{{ asset('website/images/instructor/i-1.jpg') }}" alt="Instructor">
                                        </div>
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="You-makelike mt-30">
                            ...
                            <div class="singel-makelike mt-20">
                                <div class="image">
                                    <img src="{{ asset('website/images/your-make/y-1.jpg') }}" alt="Image">
                                </div>
                                <div class="cont">
                        ...
                        <div class="col-md-6">
                            <div class="singel-course mt-30">
                                ...
                                <div class="cont">
                                    ...
                                    <span>(20 Reviws)</span>
                                    <a href="{{ route('website.courses-singel')}}"><h4>Learn basis javascirpt from start for beginner</h4></a>
                                    <div class="course-teacher">
                                        <div class="thum">
                                            <a href="#"><img src="{{ asset('website/images/course/teacher/t-2.jpg') }}" alt="teacher"></a>
                                        </div>
                                        <div class="name">
                        ...
                        <div class="col-md-6">
                            <div class="singel-course mt-30">
                                ...
                                <div class="cont">
                                    ...
                                    <div class="course-teacher">
                                        <div class="thum">
                                            <a href="#"><img src="{{ asset('website/images/course/teacher/t-3.jpg') }}" alt="teacher"></a>
                                        </div>
                                        <div class="name">
                                            <a href="#"><h6>Mark anthem</h6></a>
                                        </div>
