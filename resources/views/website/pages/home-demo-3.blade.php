                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <span>(20 Reviws)</span>
                            <a href="{{asset('website.courses-singel')}}"><h4>Learn basis javascirpt from start for beginner</h4></a>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    ...
                                    <div class="cont">
                                        <a href="{{asset('website.teachers-singel')}}"><h6>Mark alen</h6></a>
                            ...
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    ...
                                    <div class="cont">
                                        <a href="{{asset('website.teachers-singel')}}"><h6>David card</h6></a>
                            ...
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    ...
                                    <div class="cont">
                                        <a href="{{asset('website.teachers-singel')}}"><h6>Rebeka alig</h6></a>
                                        <span>Pro chencelor</span>
                                    </div>
                                </div> <!-- singel teachers -->
                            </div>
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    ...
                                    <div class="cont">
                                        <a href="{{asset('website.teachers-singel')}}"><h6>Hanna bein</h6></a>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        ...
                        <div class="cont">
                            <div class="name">
                                <a href="{{asset('website.shop-singel')}}"><h6>Set for life </h6></a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        ...
                        <div class="cont">
                            <div class="name">
                                <a href="{{asset('website.shop-singel')}}"><h6>A Daughters </h6></a>
                                <span>By Scott Trench</span>
                            </div>
                            <div class="button text-right">
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        ...
                        <div class="cont">
                            <div class="name">
                                <a href="{{asset('website.shop-singel')}}"><h6>A Magnet </h6></a>
                                <span>By Scott Trench</span>
                            </div>
                            <div class="button text-right">
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        ...
                        <div class="cont">
                            <div class="name">
                                <a href="{{asset('website.shop-singel')}}"><h6>Pices of light</h6></a>
                                <span>By Scott Trench</span>
                            </div>
                            <div class="button text-right">
